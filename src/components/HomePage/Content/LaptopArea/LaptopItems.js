...
class LaptopItems extends Component {
  ...
  upItem = (quantity) => {
    if (quantity >= 5) {
      toast.error('Bạn chỉ có thể mua tối đa là 5 cho 1 sản phẩm')
      return
    }
    this.setState({
      quantity: quantity + 1
          ...
          <div className="product_desc">
            ...
            <div className="add-actions">
              <ul className="add-actions-link">
                <li className="add-cart active"><Link to="#" onClick={() => this.addItemToCart(product)}>Thêm giỏ hàng</Link></li>
                  ...
                  <div className="col-lg-7 col-md-6 col-sm-6">
                    <div className="product-details-view-content pt-60">
                      <div className="product-info">
                        ...
                        <li><Link onClick={(id) => this.addItemToFavorite(product.id)} className="links-details" to="#"><i className="fa fa-heart-o" /> Thêm vào yêu thích</Link></li>
