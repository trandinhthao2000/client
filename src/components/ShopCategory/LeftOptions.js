    ...
    return (
      <div className="col-lg-3 order-2 order-lg-1">
        <div className="sidebar-categores-box">
          ...
          <button onClick={() => this.handleProductsProducerAll()} className="btn-clear-all mb-sm-30 mb-xs-30">Xoá Tất Cả</button>
            ...
            <div className="size-checkbox">
              <form action="/">
                <ul>
                  ...
                  <li><Link to="#" onClick={(price) => this.handleProductsPrice(1)}><b>Nhiều hơn</b> $1000</Link></li>
                </ul>
              </form>
            </div>
          </div>
