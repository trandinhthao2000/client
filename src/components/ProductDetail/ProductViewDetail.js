...
class ProductViewDetail extends Component {
  ...
  handleSubmitRating = async (event, productId) => {
    ...
    if (!token) {
      return toast.error("Vui lòng đăng nhập trước khi đánh giá");
    }
  ...
  downItem = () => {
    let quantity = this.state.quantity;
    if (quantity <= 1) {
      return toast.error("Bạn không thể giảm nữa");
    }
    this.setState({
      quantity: --quantity,
    });
        ...
        <div className="container">
          <div className="row single-product-area">
            <div className="col-lg-5 col-md-6 mt-2">
              ...
              >
                <h4 ref={(subtitle) => (this.subtitle = subtitle)}>Đánh giá sản phẩm</h4>
                <div
                ...
                <div className="product-info">
                  ...
                  <div className="rating-box pt-20">
                    <ul className="rating rating-with-review-item">
                      ...
                      >
                        <li className="review-item">Viết đánh giá </li>
                      </button>
                    </ul>
                    <li>
